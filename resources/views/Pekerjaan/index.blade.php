    ...
    <div class="admin-main">
        <div class="bg-white h-full w-full rounded-xl p-3  mb-2">
            <div class="admin-toolbar flex w-full justify-between items-start lg:items-center gap-3 flex-wrap lg:flex-nowrap">
                <p class="text-[25px] font-black text-[#01683d]">RESUME / PEKERJAAN</p>
                <div class="flex justify-between items-center py-4 ">
                    ...
                    <div class="flex flex-row items-center gap-3">
                        ...
                        <div class="flex flex-row items-center gap-2">
                            ...
                            <?php if($_GET['Tahun'] == ''){ ?>
                            <select id="tahun"
                                onChange="document.location.href='pekerjaan?filter=' + this.value + '&Tahun=' + {{ $_GET['Tahun'] == null ? '2024' : $_GET['Tahun'] }} + '&Bulan=' + {{ $_GET['Bulan'] == null ? '1' : $_GET['Bulan'] }} "
                        ...
                        <div class="flex flex-row items-center gap-2">
                            ...
                            <?php if($_GET['Tahun'] == ''){ ?>
                            <select id="tahun"
                                onChange="document.location.href='pekerjaan?filter=' + {{ $_GET['filter'] == null ? '1' : $_GET['filter'] }} + '&Tahun=' + this.value + '&Bulan=' + {{ $_GET['Bulan'] == null ? '1' : $_GET['Bulan'] }} "
                                class="bg-white border border-gray-300 text-[#005C3A] font-bold text-sm rounded-full px-3 py-1">
                        ...
                        <div class="flex flex-row items-center gap-2">
                            ...
                            <select id="countries" id="language"
                                onChange="document.location.href='pekerjaan?filter=' + {{ $_GET['filter'] == null ? '1' : $_GET['filter'] }} + '&Tahun=' + {{ $_GET['Tahun'] == null ? '2024' : $_GET['Tahun'] }} + '&Bulan=' + this.value "
                        ...
                        {{-- download --}}
                        <a href="{{ route('exports.download', ['type' => 'pekerjaan', 'filter' => $_GET['filter'] == null ? 1 : $_GET['filter'], 'Tahun' => $_GET['Tahun'] == null ? 1 : $_GET['Tahun'], 'Bulan' => $_GET['Bulan'] == null ? 1 : $_GET['Bulan']]) }}"
