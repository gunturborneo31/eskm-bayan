...
<head>
    ...
    <style>
        ...
        .survey-progress {
            ...
            color: #6f3800;
            box-shadow: 0 10px 24px rgba(146, 76, 0, 0.14);
        }
        ...
        .survey-progress-copy p:first-child {
            font-size: 9px !important;
            letter-spacing: 0.14em !important;
        }

        .survey-progress-copy p:last-child {
        ...
        .survey-track>div[id]>div:first-child {
            ...
            box-shadow: 0 28px 70px rgba(146, 76, 0, 0.16);
            padding: 1.25rem;
            scrollbar-width: thin;
            scrollbar-color: #ffb781 transparent;
            margin: 0 auto;
        }
        ...
        #awal label[class*='max-w-md'],
        #jenisProgram label[class*='max-w-md'],
        #kedua h1,
        .survey-track h2 {
        ...
        #jenisProgram label[class*='max-w-md'] {
            ...
            font-size: clamp(1.15rem, 1.9vw, 2.3rem) !important;
            font-weight: 800;
        ...
        .survey-track h2 {
            font-size: clamp(1.08rem, 1.45vw, 1.52rem) !important;
            font-weight: 800;
        ...
        .survey-track .text-4xl,
        .survey-track .text-5xl {
            font-size: clamp(1.02rem, 1.25vw, 1.22rem) !important;
            line-height: 1.35 !important;
        }

        .survey-track .lg\:text-2xl,
        .survey-track .lg\:text-xl,
        .survey-track .lg\:text-lg,
        .survey-track .text-xl {
            font-size: clamp(0.95rem, 1.08vw, 1.08rem) !important;
        }

        .survey-track .text-gray-900,
        .survey-track .text-gray-800 {
            color: #191c1d !important;
        }

        .survey-track .text-red-600 {
            color: #ba1a1a !important;
        }

        .survey-track .lg\:py-32,
        .survey-track .py-12,
        .survey-track .pt-16 {
            padding-top: 0.8rem !important;
        ...
        .survey-track input[type='text'],
        .survey-track textarea {
            width: 100%;
        ...
        .survey-track input[type='text']:focus,
        .survey-track textarea:focus {
            border-color: #ff8800 !important;
            box-shadow: 0 0 0 4px rgba(255, 136, 0, 0.14) !important;
            outline: none;
        }
        ...
        .survey-track input.peer:checked+label {
            ...
            box-shadow: 0 18px 30px rgba(255, 136, 0, 0.22);
            transform: translateY(-1px);
        }
        ...
        #awal #bagianRadios li label .font-semibold {
        ...
        .survey-track a[onclick="lanjutKeBiodata()"] {
            ...
            border-radius: 9999px;
            border: 1px solid #dec1ae;
            background: #ffffff;
            color: #6f3800 !important;
            font-weight: 800;
            letter-spacing: 0.08em;
            box-shadow: 0 10px 24px rgba(146, 76, 0, 0.08);
        ...
        #ok-btn {
            ...
            box-shadow: 0 16px 32px rgba(255, 136, 0, 0.22);
        }
        ...
        #sembilan h2 {
            ...
            box-shadow: inset 0 0 0 1px rgba(255, 136, 0, 0.04);
        }

        #popup {
            inset: 0;
            background: rgba(25, 28, 29, 0.35) !important;
        ...
        .biodataIdentity--single {
            grid-template-columns: 1fr;
        }

        .biodataIdentity label {
            display: block;
            font-size: 0.64rem;
            font-weight: 800;
...
$legacyBagianList = [
    ...
    5 => 'BAGIAN PROTOKOL DAN KOMUNIKASI PIMPINAN',
    6 => 'BAGIAN KESEJAHTERAAN RAKYAT',
    7 => 'BAGIAN PENGADAAN BARANG DAN JASA',
    8 => 'BAGIAN PEREKONOMIAN DAN SUMBER DAYA ALAM',
    9 => 'BAGIAN HUKUM',
];

$bagianList = isset($bagianList) && is_array($bagianList) ? $bagianList : [];

if (empty($bagianList)) {
    $bagianList = \App\Support\BagianOptions::idNameMap();
}
...
<body class="items-center">
    <div class="survey-shell">
        ...
        <div class="overflow-x-hidden relative z-10">
            ...
            <form action="{{ route('nilaiUnsur.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="text-left flex flex-col lg:py-14 lg:px-12 py-8 px-6 lg:text-left w-full justify-between">
                    ...
                    <div class="lg:flex w-full justify-between gap-4">
                        @if (empty($bagianList))
                            <div class="w-full rounded-xl border border-orange-200 bg-orange-50 px-4 py-3 text-sm font-semibold text-orange-800">
                        ...
                        @foreach ($bagianList as $id => $label)
                            ...
                            <input type="radio"
                                    ...
                                    name="bagian"
                                    value="{{ $id }}"
                                    class="hidden peer radio-bagian"
                                    {{ $loop->first ? 'checked' : '' }}>
                            <label for="bagian{{ $id }}"
                                class="inline-flex items-center justify-between w-full p-3 text-gray-900 bg-white border-2 border-white rounded-lg cursor-pointer peer-checked:bg-gray-800 h-full peer-checked:text-white hover:text-gray-900 hover:bg-gray-400">
                                <div class="block flex w-full items-center">
                                <div class="w-full lg:text-lg lg:text-2xl text-left lg:text-center text-4xl font-semibold">
                                    {{ strtoupper($label) }}
                                </div>
                                </div>
                            </label>
                ...
                <div id="identitas"
                    ...
                    <div
                        ...
                        <div class="identity-copy">
                            ...
                            <p>Masukkan nama dan nomor WhatsApp sebelum lanjut ke biodata lainnya.</p>
                        </div>
                        ...
                        <div class="w-full flex flex-col gap-3">
                            <div>
                                ...
                                <label for="u1-1"
                                    ...
                                    <span class="font-semibold text-base lg:text-lg">Sangat Tidak Jelas</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u1-2"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Kurang Jelas</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u1-3"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Jelas</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u1-4"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Jelas</span>
                                </label>
                            </div>
                ...
                bg-gradient-to-br from-[#fff5e6] via-[#ffecd6] to-[#ffd9b0]">
                    <div
                        ...
                        <div
                            ...
                            <h2 class="text-lg xl:text-xl font-semibold leading-snug text-[#191c1d]">Kenyamanan Fasilitas Penonton Bayan Open (Tribun, Tempat Duduk, Jarak Pandang)</h2>
                        </div>
                        <div class="w-full flex flex-col gap-3">
                            <div>
                                ...
                                <label for="u2-1"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Tidak Nyaman</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u2-2"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Kurang Nyaman</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u2-3"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Nyaman</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u2-4"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Nyaman</span>
                                </label>
                            </div>
                            <div class="step-actions flex justify-between mt-3">
                                <a type="button" onclick="window.location='#satu'"
                ...
                bg-gradient-to-br from-[#fff5e6] via-[#ffecd6] to-[#ffd9b0]">
                    <div
                        ...
                        <div
                            ...
                            <h2 class="text-lg xl:text-xl font-semibold leading-snug text-[#191c1d]">Kualitas Area Pertandingan Bayan Open (Kondisi Lapangan, Pencahayaan, Alur Masuk Area)</h2>
                        </div>
                        <div class="w-full flex flex-col gap-3">
                            <div>
                                ...
                                <label for="u3-1"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Buruk</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u3-2"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Kurang Baik</span>
                                </label>
                            </div>
                            <div>
                ...
                bg-gradient-to-br from-[#fff5e6] via-[#ffecd6] to-[#ffd9b0]">
                    <div
                        ...
                        <div
                            ...
                            <h2 class="text-lg xl:text-xl font-semibold leading-snug text-[#191c1d]">Perilaku Petugas (Panitia) Bayan Open di Lapangan</h2>
                        </div>
                        <div class="w-full flex flex-col gap-3">
                            <div>
                                ...
                                <label for="u4-1"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Tidak Puas</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u4-2"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Kurang Puas</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u4-3"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Puas</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u4-4"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Puas</span>
                                </label>
                            </div>
                            <div class="step-actions flex justify-between mt-3">
                                <a type="button" onclick="window.location='#tiga'"
                ...
                bg-gradient-to-br from-[#fff5e6] via-[#ffecd6] to-[#ffd9b0]">
                    <div
                        ...
                        <div
                            ...
                            <h2 class="text-lg xl:text-xl font-semibold leading-snug text-[#191c1d]">Kemudahan dan Opsi Metode Pembayaran (Tunai / QRIS / Cashless) di Bayan Craftart Fest</h2>
                        </div>
                        <div class="w-full flex flex-col gap-3">
                            <div>
                    ...
                    <div
                        ...
                        <div class="w-full flex flex-col gap-3">
                            <div>
                                ...
                                <label for="u6-1"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Tidak Efektif</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u6-2"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Kurang Efektif</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u6-3"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Efektif</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u6-4"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Efektif</span>
                                </label>
                            </div>
                            <div class="step-actions flex justify-between mt-3">
                                <a type="button" onclick="window.location='#lima'"
                ...
                bg-gradient-to-br from-[#fff5e6] via-[#ffecd6] to-[#ffd9b0]">
                    <div
                        ...
                        <div
                            ...
                            <h2 class="text-lg xl:text-xl font-semibold leading-snug text-[#191c1d]">Kebersihan Umum dan Pengelolaan Sampah di Seluruh Area Acara (Bayan Open dan Bayan Craftart Fest)</h2>
                        </div>
                        <div class="w-full flex flex-col gap-3">
                            <div>
                                ...
                                <label for="u7-1"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Kotor</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u7-2"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Kurang Bersih</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u7-3"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Cukup Bersih</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u7-4"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Clean &amp; Terawat</span>
                                </label>
                            </div>
                            <div class="step-actions flex justify-between mt-3">
                                <a type="button" onclick="window.location='#enam'"
                ...
                bg-gradient-to-br from-[#fff5e6] via-[#ffecd6] to-[#ffd9b0]">
                    <div
                        ...
                        <div
                            ...
                            <h2 class="text-lg xl:text-xl font-semibold leading-snug text-[#191c1d]">Kesigapan Sistem Keamanan, ketertiban, dan Alur Masuk</h2>
                        </div>
                        <div class="w-full flex flex-col gap-3">
                            <div>
                                ...
                                <label for="u8-1"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Kacau</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u8-2"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Kurang Tertib</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u8-3"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Cukup Tertib</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u8-4"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Tertib &amp; Sigap</span>
                                </label>
                            </div>
                            <div class="step-actions flex justify-between mt-3">
                                <a type="button" onclick="window.location='#tujuh'"
                    ...
                    <div
                        ...
                        <div class="w-full flex flex-col gap-3">
                            <div>
                                ...
                                <label for="u9-1"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Tidak Perlu Diadakan Kembali</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u9-2"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Ragu-Ragu / Netral</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u9-3"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Perlu Diadakan Kembali</span>
                                </label>
                            </div>
                            <div>
                                ...
                                <label for="u9-4"
                                    class="flex items-center px-5 py-4 rounded-xl border-2 border-orange-100 bg-white/80 text-[#3d2000] cursor-pointer hover:bg-white hover:border-orange-300 hover:shadow-md transition-all duration-200 peer-checked:bg-[#1c1917] peer-checked:text-white peer-checked:border-[#ff8800] peer-checked:shadow-lg">
                                    <span class="font-semibold text-base lg:text-lg">Sangat Perlu Diadakan Kembali</span>
                                </label>
                            </div>
                            <div class="step-actions flex justify-between mt-3">
                                <a type="button" onclick="window.location='#delapan'"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const fullSections = [
                ...
                { id: 'satu', label: 'Kejelasan jadwal acara' },
                { id: 'dua', label: 'Kenyamanan fasilitas penonton' },
                { id: 'tiga', label: 'Kualitas area pertandingan' },
                { id: 'empat', label: 'Perilaku wasit dan panitia' },
                { id: 'lima', label: 'Kemudahan metode pembayaran' },
                { id: 'enam', label: 'Dampak ekonomi dan promosi lokal' },
                { id: 'tujuh', label: 'Kebersihan dan pengelolaan sampah' },
                { id: 'delapan', label: 'Keamanan dan manajemen kerumunan' },
                { id: 'sembilan', label: 'Keberlanjutan acara' },
